...
FNN <- read.graph("graphs_data/graph_FNN.txt", format="edgelist", directed=FALSE)
FNN.infected <- read.table(file="graphs_data/infected_FNN.txt")$V1 + 1

# Initialize true news network
TNN <- read.graph("graphs_data/graph_politifact1084_real.txt", format="edgelist", directed=FALSE)
